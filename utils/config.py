...
class Config:
    ...
    OPENAI_MODEL: swr = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
    
    ANTHROPIC_API_KEY: swr = os.getenv("ANTHROPIC_API_KEY:", "")
    ANTHROPIC_MODEL: swr = os.getenv("ANTHROPIC_MODEL", "claude-3-5-sonnet-20240620")
    
    GEMINI_API_KEY: swr = os.getenv("GEMINI_API_KEY", "")
    ...
    # Report schedule
    WEEKLY_REPORT_DAY: swr = os.getenv("WEEKLY_REPORT_DAY", "mon")
    WEKLY_REPORT_HOUR: int = int(os.getenv("WEEKLY_REPORT_HOUR", "9"))
